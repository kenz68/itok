...
class RatingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        loadNib()
        NotificationCenter.default.addObserver(self, selector: #selector(RatingViewController.keyboardWillShow), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(RatingViewController.keyboardWillHide), name: UIResponder.keyboardWillHideNotification, object: nil)
